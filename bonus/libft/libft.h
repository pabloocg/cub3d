...
void						ft_putnbr_base(t_intmax nb, char *str,
							t_printf **bag);
void						putmemory_printf(t_printf **bag);
size_t						ft_nbrmemlen(t_uintptr num);
void						ft_putnbr_base_mem(t_uintptr nb, char *str,
							t_printf **bag);
...
int							putnbr_plus_space_bonus(t_intmax number,
							t_printf **bag);
int							putnbr_plus_space2_bonus(t_intmax number,
							t_printf **bag);
void						putnbr_print_plus_space(int symbol,
							t_intmax number, t_printf **bag);
int							putnbr_plus_space3_bonus(t_intmax number,
							t_printf **bag);
